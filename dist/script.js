...
/* harmony import */ var _ckeckNumInput__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ckeckNumInput */ "./src/js/modules/ckeckNumInput.js");



var changeModalState = function changeModalState(state) {
  var balcons = document.querySelectorAll('.balcon_icons_img');
  var balconWidth = document.querySelectorAll('#width');
  var balconHeight = document.querySelectorAll('#height');
  var balconType = document.querySelectorAll('#view_type');
  var balconProfile = document.querySelectorAll('.checkbox');
  Object(_ckeckNumInput__WEBPACK_IMPORTED_MODULE_1__["default"])('#width');
  Object(_ckeckNumInput__WEBPACK_IMPORTED_MODULE_1__["default"])('#height');
...
/***/ "./src/js/modules/ckeckNumInput.js":
/*!*****************************************!*\
  !*** ./src/js/modules/ckeckNumInput.js ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony import */ var _ckeckNumInput__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ckeckNumInput */ "./src/js/modules/ckeckNumInput.js");
...
var form = function form(state) {
  ...
  Object(_ckeckNumInput__WEBPACK_IMPORTED_MODULE_6__["default"])('input[name="user_phone"]');
  var message = {
    loading: 'Загрузка...',
...
var modals = function modals(state) {
  function bindModal(triggersSelector, modalSelector, closeSelector) {
    ...
    var validation = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    ...
    triggers.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        if (validation) {
          var statusMessage = item.previousElementSibling;
          ...
          var missingProps = props.filter(function (item) {
            return !state.hasOwnProperty(item) || state[item] === '';
          });
          missingProps.forEach(function (prop) {
            switch (prop) {
              case 'form':
                statusMessage.insertAdjacentHTML('beforeend', "<p>".concat(message.form, "</p>"));
                break;

              case 'width':
                statusMessage.insertAdjacentHTML('beforeend', "<p>".concat(message.width, "</p>"));
                break;

              case 'height':
                statusMessage.insertAdjacentHTML('beforeend', "<p>".concat(message.height, "</p>"));
                break;

              case 'type':
                statusMessage.insertAdjacentHTML('beforeend', "<p>".concat(message.type, "</p>"));
                break;

              case 'profile':
                statusMessage.insertAdjacentHTML('beforeend', "<p>".concat(message.profile, "</p>"));
                break;
            }
          });
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false, true, ['type', 'profile']); // showModalByTime('.popup', 60000)
};
...
var tabs = function tabs(wrapperTabsSelector, tabSelector, contentSelector, activeClass) {
  var type = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
  var wrapperTabs = document.querySelector(wrapperTabsSelector);
  ...
  hideTabContent();
  showTabContent();
  wrapperTabs.addEventListener('click', function (e) {
    var target = e.target;
...
var timer = function timer(deadLine) {
  ...
  var getTimeToDeadLine = function getTimeToDeadLine() {
    var total = Date.parse(deadLine) - Date.now();
    var seconds = Math.floor(total / 1000 % 60);
    var minutes = Math.floor(total / 1000 / 60 % 60);
    var hours = Math.floor((total / (1000 * 60 * 60) + 2) % 24);
