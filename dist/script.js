...
var modals = function modals() {
  ...
  bindMondal('.phone_link', '.popup', '.popup .popup_close'); // showModalByTime('.popup', 60000)
};
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  var headerTab = document.querySelector(headerSelector);
  var tab = document.querySelectorAll(tabSelector);
  var contentTab = document.querySelectorAll(contentSelector);
  ...
  function showTabContent(index) {
    contentTab[index].style.display = 'block';
